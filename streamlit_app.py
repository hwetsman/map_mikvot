...
undated_n = undated_df.shape[0]
total_n = data.shape[0]

col2.write(f"""A mikveh (Hebrew plural: mikvot) is a Jewish ritual bath used
...
There are {undated_n} undated and {total_n-undated_n} dated sites in this dataset.""")
